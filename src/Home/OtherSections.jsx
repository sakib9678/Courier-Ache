  ...
  return (
    <div className="mx-auto container py-10">
      ...
      <div className="py-10 bg-gradient-to-r from-[#FFFAF7] to-[#FEF7F1] rounded-lg">
        <h2 className="text-3xl sm:text-4xl font-semibold text-center mb-10">Our Services</h2>
        <div className="flex flex-wrap justify-center gap-8">
          <div className="flex flex-col items-center gap-4 bg-white p-6 rounded-lg shadow-md w-60 sm:w-72">
            <img
            ...
            />
            <p className="text-lg sm:text-xl font-medium">E-commerce Delivery</p>
          </div>
          <div className="flex flex-col items-center gap-4 bg-white p-6 rounded-lg shadow-md w-60 sm:w-72">
            <img
              ...
              className="w-32 sm:w-40 h-32 sm:h-40 object-cover rounded-full"
            />
            <p className="text-lg sm:text-xl font-medium">Pick and Drop</p>
          </div>
          <div className="flex flex-col items-center gap-4 bg-white p-6 rounded-lg shadow-md w-60 sm:w-72">
            <img
              ...
              className="w-32 sm:w-40 h-32 sm:h-40 object-cover rounded-full"
            />
            <p className="text-lg sm:text-xl font-medium">Packaging</p>
          </div>
          <div className="flex flex-col items-center gap-4 bg-white p-6 rounded-lg shadow-md w-60 sm:w-72">
            <img
              ...
              className="w-32 sm:w-40 h-32 sm:h-40 object-cover rounded-full"
            />
            <p className="text-lg sm:text-xl font-medium">Warehousing</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            ...
            <div className="w-full p-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-lg w-60 sm:w-72">
                  ...
                  <h5 className="mt-2 text-lg sm:text-xl font-medium">Daily Pickup, No Limits</h5>
                ...
                <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-lg w-60 sm:w-72">
                  ...
                  <h5 className="mt-2 text-lg sm:text-xl font-medium">Cash on Delivery</h5>
                  <p className="mt-2 text-gray-600">
                ...
                <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-lg w-60 sm:w-72">
                  ...
                  <h5 className="mt-2 text-lg sm:text-xl font-medium">Fast Payment Service</h5>
                  <p className="mt-2 text-gray-600">
                ...
                <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-lg w-60 sm:w-72">
                  ...
                  <h5 className="mt-2 text-lg sm:text-xl font-medium">Online Management</h5>
                  <p className="mt-2 text-gray-600">
